...
namespace Naninovel
{
    ...
    public sealed class IDEActorAttribute : IDEParameterPayloadAttribute
    {
        ...
        public IDEActorAttribute (string pathPrefix = "*", int namedIndex = -1) : base(pathPrefix, namedIndex) { }
    }
}
