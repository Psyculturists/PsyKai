...
namespace Naninovel
{
    ...
    public sealed class IDEResourceAttribute : IDEParameterPayloadAttribute
    {
        ...
        public IDEResourceAttribute (string pathPrefix, int namedIndex = -1) : base(pathPrefix, namedIndex) { }
    }
}
