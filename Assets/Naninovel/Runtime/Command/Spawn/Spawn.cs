...
namespace Naninovel.Commands
{
    ...
    public class Spawn : Command, Command.IPreloadable
    {
        ...
        {
            void SetSpawnParameters (IReadOnlyList<string> parameters);
        }

        public interface IAwaitable
        {
            UniTask AwaitSpawnAsync (CancellationToken cancellationToken = default);
        }
        ...
        {
            var spawnedObject = await SpawnManager.GetOrSpawnAsync(Path);
