...
namespace Naninovel
{
    public class ResourcesBuilder
    {
        ...
        private void CheckProjectResourceConflict (string assetGuid, string resourcePath)
        {
            ...
            throw new InvalidOperationException($"Resource conflict detected: asset stored at `{otherPath}` conflicts with `{resourcePath}` Naninovel resource; rename or move the conflicting asset.");
        }
