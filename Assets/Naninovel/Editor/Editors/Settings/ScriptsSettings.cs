...
namespace Naninovel
{
    public class ScriptsSettings : ResourcefulSettings<ScriptsConfiguration>
    {
        ...
        protected override Dictionary<string, Action<SerializedProperty>> OverrideConfigurationDrawers ()
        {
            ...
            drawers[nameof(ScriptsConfiguration.WatchScripts)] = p => OnChanged(() => EditorGUILayout.PropertyField(p), ScriptFileWatcher.Initialize);
            drawers[nameof(ScriptsConfiguration.WatchedDirectory)] = p => { if (Configuration.WatchScripts) OnChanged(() => EditorUtils.FolderField(p), ScriptFileWatcher.Initialize); };
